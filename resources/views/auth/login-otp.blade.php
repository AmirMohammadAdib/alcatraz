...
@section('content')
    <section class="container mt-50">
        <div class="row justify-content-center">
            <form action="{{ route('login.otp.store') }}" class="login-form col-11 col-md-5" method="POST">
                @csrf 
                <div class="text-center">
                    <h1 class="font-30 font-bold">تایید شماره</h1>
                ...
                <div class="mt-20 d-flex justify-content-between">
                    <a href="{{ route('login.pass.view') }}" class="text-white">ورود با رمز عبور</a>
                </div>
