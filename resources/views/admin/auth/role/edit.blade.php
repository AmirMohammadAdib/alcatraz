...
@section('breadcrumb')
    ...
    <li><a href="{{ route('role.create') }}">ویرایش</a></li>
@endsection
                ...
                <div class="form-body">
                    <div class="form-group">
                        ...
                        <div class="input-group @error('name') has-error @enderror">
                            ...
                            <input type="text" class="form-control" placeholder="عنوان نقش" value="{{ old('name', $role->name) }}" name="name">
                        ...
                        <div class="input-group">
                            <div class="col-12 d-flex flex-wrap">
                                @foreach ($permissions as $permission)
                                    <div class="col-3">
                                        <input type="checkbox" name="permissions[]" {{ in_array($permission->id, $selectedPermissions) ? 'checked' : '' }} value="{{ $permission->name }}" id="{{ $permission->id }}">
