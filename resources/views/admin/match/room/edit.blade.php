            ...
            <form role="form" method="POST" action="{{ route('room.update', $room) }}">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group @error('title') has-error @enderror">
                        ...
                        <input type="text" class="form-control" placeholder="عنوان محصول" value="{{ old('title', $room->title) }}" name="title">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group relative">
                        ...
                        <img src="{{ asset('images/rooms/' . $room->img) }}" width="200" class="mt-2">
