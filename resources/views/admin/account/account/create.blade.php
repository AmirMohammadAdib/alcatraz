...
@section('breadcrumb')
    ...
    <li><a href="{{ route('account.create') }}">ایجاد</a></li>
@endsection
                ...
                <div class="form-body">
                    <div class="form-group">
                        ...
                        <div class="input-group @error('title') has-error @enderror">
                            ...
                            <input type="text" class="form-control" placeholder="عنوان اکانت" value="{{ old('title') }}" name="title">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group @error('price') has-error @enderror">
                            ...
                            <input type="number" class="form-control" placeholder="قیمت اکانت" value="{{ old('price') }}" name="price">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group @error('description') has-error @enderror">
                            ...
                            <textarea class="form-control" placeholder="" name="description">{{ old('description') }}</textarea>
