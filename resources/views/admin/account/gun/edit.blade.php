...
@section('breadcrumb')
    ...
    <li><a href="{{ route('gun.create') }}">ویرایش</a></li>
@endsection
...
<div class="col-12">
    <div class="portlet box shadow">
        ...
        <div class="portlet-body">
            <form role="form" method="POST" action="{{ route('gun.update', $gun) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="form-body">
                    <div class="form-group">
                        ...
                        <div class="input-group @error('name') has-error @enderror">
                            ...
                            <input type="text" class="form-control" placeholder="عنوان گان" value="{{ old('name', $gun->name) }}" name="name">
