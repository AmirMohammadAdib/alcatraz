...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'unit' => "پلاک خانه",
         "no" => "واحد",
         "recipient_first_name" => "نام کوچک گیرنده",
         ...
         "work_time" => "زمان کار",
        "repairman" => "تعمیر کار",
        "order_final_amount" => "مبلغ نهایی سفارش",
        ...
        'problem' => 'مشکل',
        'about_dr' => 'درباره دکتر',
        'biography' => 'بیوگرافی',
        'since_date' => 'تاریخ شروع',
        'until_date' => 'تاریخ پایان',
        'since_hour' => 'ساعت شروع',
        'until_hour' => 'ساعت پایان',
        'speciality_id' => 'تخصص',
        'sub_speciality_id' => 'فوق تخصص',
        'services' => 'سرویس',
        'turn_times' => 'زمان ویزیت',
        'secretaries' => 'منشی ',
        'profile' => 'پروفایل',
        'ME_number' => 'کد نظام پزشکی',
        'insurance_id' => 'بیمه',
        'city_id' => 'شهر',
        'role_id' => 'نقش',
        'province_id' => 'استان',
        ...
        'doctors'=>'دکتر ها',
        'meta_description' => 'متا دسکریپشن',
        'meta_name' => 'متا نام',
        'robots' => 'روباتس',
        'content' => 'محتوا',
        'contentable' => 'نوع محتوا',
        'contentable_id' => 'شناسه محتوا',
        'meta_key_words' => 'کلمات کلیدی',
        'link' => 'لینک',
        'visit_date' => 'تاریخ ویزیت',
        'address_id' => 'آدرس',
        'amount' => 'مبلغ',
        'visit_time_id' => 'زمان ویزیت',
        'doctor_id' => 'دکتر',
        'otp' => 'کد یکبار مصرف',
        'roles' => 'نقش ها',
        'score' => 'امتیاز', 
        'how_did_you_meet' => 'چطور آشنا شدید',
        'waiting_time' => 'زمان انتظار', 
        'how_was_result' => 'نتیجه چگونه بود', 
        'comment' => 'کامنت', 
        'suggest'  => 'پیشنهاد',
		'card_number' => 'شماره کارت',
		'account_number' => 'شماره حساب',
		'shabba_number' => 'شماره شبا',
		'full_name' => 'نام',
        'phone' => 'تلفن',
        're_password' => 'تکرار رمز عبور',
        'address_phone' => 'تلفن آدرس',
        'address_mobile' => 'موبایل آدرس',
        ...
        'weight' => 'مقدار',
        'date' => "تاریخ",
        'delivery_amount' => 'مبلغ حمل و نقش',
        'discount' => 'تخفیف',
        ...
        'alt' => 'متن تصویر',
        'driver_id' => 'راننده',
        'home_price' => 'قیمت خانگی',
        'wholesale_price' => 'قیمت تجاری',
        'referal_code' => 'کد معرف',
